...
The frontend server expects the backend to be running on port 5050, and requests for paths starting with `/api/` to be proxied to the backend. Vite is configured to do this; however, in deployment this will have to be done independently.
